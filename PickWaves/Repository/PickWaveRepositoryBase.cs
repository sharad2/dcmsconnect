...
UNVRFY_BOXES,
 ...
 (SELECT PS.BUCKET_ID AS BUCKET_ID,
              ...
              COUNT(UNIQUE CASE
                            WHEN BOX.STOP_PROCESS_REASON = '$BOXCANCEL' AND box.carton_id IS NULL THEN
                            BOX.UCC128_ID END)                AS CANCEL_BOXES_PITCH,
  
              COUNT(UNIQUE CASE WHEN BOX.STOP_PROCESS_REASON = '$BOXCANCEL' AND box.carton_id IS NOT NULL THEN
