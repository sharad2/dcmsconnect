...
namespace DcmsMobile.Inquiry.Helpers
{
    public partial class DummyController
    {
        ...
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public DummyController Actions { get { return MVC_Inquiry.Inquiry.Dummy; } }
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Area = "Inquiry";
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Name = "Dummy";
        [GeneratedCode("T4MVC", "2.0")]
        public const string NameConst = "Dummy";
    ...
    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_DummyController : DcmsMobile.Inquiry.Helpers.DummyController
    {
