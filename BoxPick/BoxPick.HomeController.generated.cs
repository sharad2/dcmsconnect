...
namespace DcmsMobile.BoxPick.Areas.BoxPick.Controllers {
    public partial class HomeController {
        ...
        [NonAction]
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public System.Web.Mvc.ActionResult AcceptBuilding() {
            return new T4MVC_ActionResult(Area, Name, ActionNames.AcceptBuilding);
        }
        [NonAction]
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public System.Web.Mvc.ActionResult AcceptPallet() {
            return new T4MVC_ActionResult(Area, Name, ActionNames.AcceptPallet);
        }
        [NonAction]
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public System.Web.Mvc.ActionResult AcceptCarton() {
            return new T4MVC_ActionResult(Area, Name, ActionNames.AcceptCarton);
        }
        [NonAction]
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public System.Web.Mvc.ActionResult AcceptUccInCarton() {
            return new T4MVC_ActionResult(Area, Name, ActionNames.AcceptUccInCarton);
        }
        [NonAction]
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public System.Web.Mvc.ActionResult AcceptPalletInCarton() {
            return new T4MVC_ActionResult(Area, Name, ActionNames.AcceptPalletInCarton);
        }
        [NonAction]
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public System.Web.Mvc.ActionResult AcceptUcc() {
            return new T4MVC_ActionResult(Area, Name, ActionNames.AcceptUcc);
        }
        [NonAction]
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public System.Web.Mvc.ActionResult AcceptCartonInUcc() {
            return new T4MVC_ActionResult(Area, Name, ActionNames.AcceptCartonInUcc);
        }
        [NonAction]
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public System.Web.Mvc.ActionResult AcceptPalletInUcc() {
            return new T4MVC_ActionResult(Area, Name, ActionNames.AcceptPalletInUcc);
        }
    ...
    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public class T4MVC_HomeController: DcmsMobile.BoxPick.Areas.BoxPick.Controllers.HomeController {
        ...
        public override System.Web.Mvc.ActionResult AcceptBuilding(DcmsMobile.BoxPick.ViewModels.BuildingViewModel model) {
            var callInfo = new T4MVC_ActionResult(Area, Name, ActionNames.AcceptBuilding);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "model", model);
            return callInfo;
        }

        public override System.Web.Mvc.ActionResult AcceptPallet(DcmsMobile.BoxPick.ViewModels.PalletViewModel mm) {
            var callInfo = new T4MVC_ActionResult(Area, Name, ActionNames.AcceptPallet);
        ...
        public override System.Web.Mvc.ActionResult AcceptPalletInUcc(DcmsMobile.BoxPick.ViewModels.UccViewModel model) {
            var callInfo = new T4MVC_ActionResult(Area, Name, ActionNames.AcceptPalletInUcc);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "model", model);
            return callInfo;
        }
