...
namespace DcmsMobile.Inquiry.Areas.Inquiry.Home
{
    public partial class HomeController
    {
        ...
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public HomeController Actions { get { return MVC_Inquiry.Inquiry.Home; } }
        ...
        public class ViewsClass
        {
            ...
            {
                public readonly string Disambiguate = "Disambiguate";
                public readonly string Index = "Index";
            }
            public readonly string Disambiguate = "~/Areas/Inquiry/Home/Disambiguate.cshtml";
            public readonly string Index = "~/Areas/Inquiry/Home/Index.cshtml";
        }
    }

    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_HomeController : DcmsMobile.Inquiry.Areas.Inquiry.Home.HomeController
    {
